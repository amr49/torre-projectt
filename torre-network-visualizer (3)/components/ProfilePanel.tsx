    ...
    <Card className="bg-gradient-to-br from-violet-900/40 to-fuchsia-900/40 backdrop-blur-sm border-violet-500/30 shadow-xl">
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          ...
          <Button
            ...
            size="sm"
            onClick={onClose}
            className="text-white hover:bg-red-500/20 hover:text-red-200 border border-white/20 hover:border-red-400/50 transition-all duration-200"
          >
            <X className="w-4 h-4" />
          </Button>
        </div>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2">
          <Button
            variant="outline"
            className="flex-1 border-violet-400/50 text-violet-200 hover:bg-violet-500/20 hover:border-violet-300 hover:text-white"
          ...
          <Button
            variant="outline"
            onClick={onClose}
            className="border-red-400/50 text-red-200 hover:bg-red-500/20 hover:border-red-300 hover:text-white"
          >
            Close
          </Button>
        </div>
